...
namespace KerbalVR {
    public class SkeletonPose_KnobPose_Human {
        public static SteamVR_Skeleton_Pose GetInstance() {
            ...
            pose.leftHand.position = new Vector3(0.0073826257f, -0.00014942791f, -0.06413894f);
            pose.leftHand.rotation = new Quaternion(-0.93803144f, 0.23020178f, 0.15627933f, 0.20659353f);
            pose.leftHand.bonePositions = new Vector3[31] {
                new Vector3(-0.0f, 0.0f, 0.0f),
                new Vector3(-0.034037687f, 0.03650266f, 0.16472164f),
                new Vector3(-0.016308522f, 0.027526239f, 0.01779791f),
            ...
            pose.leftHand.boneRotations = new Quaternion[31] {
                ...
                new Quaternion(-0.42095608f, -0.72392756f, 0.20551412f, 0.5064474f),
            ...
            pose.rightHand.position = new Vector3(-0.0072656907f, -0.0014263075f, -0.06477983f);
