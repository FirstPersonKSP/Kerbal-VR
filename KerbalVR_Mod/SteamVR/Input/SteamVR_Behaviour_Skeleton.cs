...
namespace Valve.VR
{
    public class SteamVR_Behaviour_Skeleton : MonoBehaviour
    {
        ...
        */
        ...
        // KERBALVR: this component is meant to be loaded as a prefab, with all this data already in place
        // since KerbalVR creates these components in code, we need to manually run this logic after setting up some data
#if KERBALVR
